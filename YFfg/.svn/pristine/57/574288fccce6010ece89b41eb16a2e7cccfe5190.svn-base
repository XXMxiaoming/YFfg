...
public class XingeApp {
	...
	public static final long ANDRIOD_MAX_ID = 2100263875L;
	public static final String ANDRIOD_MYKEY = "fa3b72e140275176687f1f4b25c48ba6";
	public static final long IOS_ID = 2200263876L;
	public static final String IOS_MYKEY = "8576e52479431c4749fa5fa8556f8262";
	...
	public static JSONObject pushAccountAndroidMessage(long accessId, String secretKey, String title, String content, String account,Map<String, Object> custom)
	{
		Message message = new Message();
	...
	public static JSONObject pushAccountListAndroidMessage(long accessId, String secretKey, String title, String content, List<String> account,Map<String, Object> custom)
	{
		Message message = new Message();
		message.setType(Message.TYPE_MESSAGE);
		message.setTitle(title);
		...
		message.setCustom(custom);
		XingeApp xinge = new XingeApp(accessId, secretKey);	
		JSONObject ret = xinge.pushAccountList(0, account, message);
		return (ret);
	}
	...
	public static JSONObject pushAllAndroid2(long accessId, String secretKey, String title, String content,Map<String,Object> map)
	{
		Message message = new Message();
		message.setType(Message.TYPE_NOTIFICATION);
		message.setTitle(title);
	...
	public static JSONObject pushAccountListIosMessage(long accessId, String secretKey, String content, List<String> account, int env, Map<String, Object> custom)
	{
		MessageIOS message = new MessageIOS();
		message.setAlert(content);
		message.setBadge(1);
		...
		XingeApp xinge = new XingeApp(accessId, secretKey);	
		JSONObject ret = xinge.pushAccountList(0, account, message, env);
		return (ret);
	}
	
	public static JSONObject pushAccountIosMessage(long accessId, String secretKey, String content, String account, int env, Map<String, Object> custom)
	{
		MessageIOS message = new MessageIOS();
		message.setAlert(content);
		message.setBadge(1);
	...
	public static JSONObject pushAllIos2(long accessId, String secretKey, String content,Map<String,Object> map, int env)
	{
		MessageIOS message = new MessageIOS();
		message.setAlert(content);
		message.setBadge(1);
	...
	public JSONObject pushAccountList(int deviceType, List<String> accountList, MessageIOS message, int environment)
	{
		if (!ValidateMessageType(message, environment))
		{
			System.out.println("gdjlskagfjkd");
			return new JSONObject("{'ret_code':-1,'err_msg':'message type or environment error!'}");
		}
		if (!message.isValid())
		{System.out.println("bnvcm");
			return new JSONObject("{'ret_code':-1,'err_msg':'message invalid!'}");
		}
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("access_id", this.m_accessId);
