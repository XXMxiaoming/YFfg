...
public class ImageUtil {
    ...
    public void saveImage(String fromFileStr, String saveToFileStr,
            int formal) throws Exception {
        BufferedImage srcImage;
        File saveFile = new File(saveToFileStr);
        String type = saveToFileStr.substring(saveToFileStr
				.lastIndexOf(".") + 1);
        File fromFile = new File(fromFileStr);
        srcImage = ImageIO.read(fromFile); // construct image
        int imageWideth = srcImage.getWidth(null);
        int imageHeight = srcImage.getHeight(null);
        int changeToWideth = imageWideth / formal;
        int changeToHeight = imageHeight / formal;
        ...
        ImageIO.write(srcImage, type, saveFile);
    }
